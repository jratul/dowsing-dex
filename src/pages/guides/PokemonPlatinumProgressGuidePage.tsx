...
const GYM_PREREQS = [
  ...
  },
  {
    ...
    steps: [
      { label: '포리스트배지(2관) 취득', detail: 'HM05 안개걷기 필드 사용 조건' },
  ...
  },
  {
    gym: '8관 물가시티 — 전진 (전기)',
    steps: [
      { label: '글레이셔배지(7관) 취득', detail: 'HM08 바위오르기 필드 사용 조건' },
...
const AREA_REQS = [
  ...
  },
  {
    ...
    requirement: 'HM05 안개걷기 + 2관 포리스트배지',
  ...
  {
    area: '물가시티',
    requirement: '갤럭시단 최종 이벤트(분열세계) 완료 + HM08 바위오르기 + 7관 글레이셔배지',
      ...
      <Card className="mb-6 p-4">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="text-sm text-ink-muted">연고시티 → 동쪽 209번도로 → 신수마을 → 210번도로 북쪽 → 봉신마을. 210번도로 북부는 안개 구간이므로 HM05 안개걷기 + 2관 포리스트배지가 있어야 편하게 통과할 수 있다.</p>
          </div>
          <div>
