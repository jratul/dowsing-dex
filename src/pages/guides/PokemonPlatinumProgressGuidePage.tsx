...
const AREA_REQS = [
  ...
  {
    area: '물가시티',
    requirement: '갤럭시단 최종 이벤트(분열세계) 완료 + HM08 락클라임 + 7관 글레이셔배지',
    detail: '분열세계 이벤트 완료 전까지 물가시티로 들어가는 길 자체가 막힌다. 완료 후 210번도로 동쪽 절벽을 락클라임로 내려가 진입',
  },
  {
    area: '승리로드',
      ...
      <Card className="mb-6 p-4">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="text-sm text-ink-muted">천관산 → 스피어필라 → 분열세계(기라티나 이벤트)를 완료해야 물가시티 진입 경로가 열린다. 7관을 깬 직후에도 이 이벤트를 완료하기 전에는 갈 수 없다. 210번도로 동쪽 절벽을 HM08 락클라임로 내려가는 경로가 열린다.</p>
          </div>
          <div>
