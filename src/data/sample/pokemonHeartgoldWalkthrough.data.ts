...
export const HGW_PARTY: PartyMember[] = [
  ...
  },
  {
    pokemonId: 468,
    pokemon: '토게키스',
    catchTiming: '토게피(게임 초반) → 친밀도 진화 → 빛의돌 (포스트게임 이후)',
    role: '포스트게임 합류. 스토리 중 토게틱으로 운용. 비행/격투 타입 커버',
    keyMoves: ['에어슬래시', '파동탄', '빛의장막', '소원빌기'],
  },
]
  ...
  // ─── Phase 5 ───
  {
    ...
    boss: {
      ...
      rows: [
        ...
        { opponent: '괴력몬 Lv.30 (격투)', answer: '토게틱 에어슬래시 (비행 2배)' },
      ],
      badge: '쇼크배지',
    },
  },
  ...
  // ─── Phase 10 ───
  {
    ...
    boss: {
      ...
      rows: [
        ...
        { opponent: '도희 (독) 연분홍시티 — 독침붕·아포켈 등', answer: '블레이범 지진 (땅 2배) · 토게키스 파동탄' },
