...
export const HGW_YOUTUBER_PICKS: YoutuberPick[] = [
  ...
  },
  {
    ...
    pokemon: '마기라스',
    type: '바위/악',
    obtainedAt: '마운트실버 애버라스 포획 → Lv.30 데기라스 → Lv.55 마기라스',
    obtainTiming: '포스트게임 (관동 8관 이후, 마운트실버)',
    pros: [
    ...
    cons: [
      '마운트실버는 관동 8관 이후만 입장 가능 — 사실상 레드전 직전에만 운용 가능',
  ...
  },
  {
    ...
    pokemon: '루기아',
    type: '에스퍼/비행',
    obtainedAt: '소용돌이 섬 Lv.45 (HM06 소용돌이 필요 + 은빛날개)',
