...
export const STONE_EVO_DETAILS: EvoDetailSection[] = [
  ...
  },
  {
    ...
    moveTables: [
      { label: '진화 직후', moves: ['최면술', '누르기', '망각술', '물대포'] },
      { label: '최종', moves: ['파도타기', '망각술', '최면술', '사이코키네시스 or 지진 or 누르기'] },
    ],
    moveComparisons: [
      { move: '망각술', desc: '1세대에서는 특수 공격과 특수 내구를 동시에 강화한다. 강챙이의 핵심 강화기.' },
  ...
  },
  {
    ...
    moveTables: [
      { label: '진화 직후', moves: ['몸통박치기', '모래뿌리기', '꼬리흔들기'] },
      { label: '최종', moves: ['10만볼트', '전기자석파', '두번차기 or 바늘미사일', '전광석화 or 그림자분신'] },
    ],
    moveComparisons: [
      { move: '10만볼트', desc: '쥬피썬더의 핵심 전기 주력기.' },
      { move: '전기자석파', desc: '빠른 상대를 마비시켜 안정적으로 운영 가능.' },
      { move: '두번차기', desc: '바위·노말 등 일부 상대로 보조 견제 가능.' },
...
export const TRADE_EVO_DETAILS: EvoDetailSection[] = [
  {
    ...
    moveTables: [
      ...
      { label: 'Lv31 이후', moves: ['환상빔', 'HP회복', '사슬묶기', '순간이동'] },
      { label: '최종', moves: ['사이코키네시스', 'HP회복', '전기자석파 or 리플렉터', '지구던지기 or 그림자분신'] },
    ],
    moveComparisons: [
      { move: '환상빔', desc: '중반 에스퍼 주력기.' },
  ...
  },
  {
    ...
    moveTables: [
      { label: '교환 직후', moves: ['핥기', '이상한빛', '나이트헤드'] },
      { label: 'Lv29 이후', moves: ['최면술', '이상한빛', '나이트헤드', '핥기'] },
      { label: 'Lv38 이후', moves: ['최면술', '꿈먹기', '이상한빛', '나이트헤드'] },
 ...
 */
export const RED_EVO_MOVE_NAMES: ReadonlySet<string> = new Set([
  '사이코키네시스', '손가락흔들기', '이판사판태클', '하이드로펌프', '10만볼트', '그림자분신',
  '껍질끼우기', '껍질에숨기', '꼬리흔들기', '나이트헤드', '난동부리기', '단단해지기',
  '메가드레인', '모래뿌리기', '몸통박치기', '바늘미사일', '베어가르기', '스피드스타',
  '안다리걸기', '연속뺨치기', '잎날가르기', '전기자석파', '지구던지기', '지옥의바퀴',
  'HP회복', '거품광선', '고속이동', '구멍파기', '꽃잎댄스', '노래하기',
  '돌떨구기', '두번차기', '리플렉터', '불꽃세례', '불대문자', '뿔찌르기',
  '사슬묶기', '수면가루', '순간이동', '오로라빔', '울음소리', '웅크리기',
  '이상한빛', '작아지기', '저리가루', '전광석화', '전기쇼크', '째려보기',
  '태권당수', '파괴광선', '파도타기', '화염방사', '꿈먹기', '냉동빔',
  '누르기', '눈보라', '대폭발', '막치기', '망각술', '물대포',
  '박치기', '솔라빔', '염동력', '용해액', '잠자기', '초음파',
  '최면술', '할퀴기', '환상빔', '거품', '괴력', '녹기',
  '독침', '돌진', '물기', '번개', '자폭', '지진',
  '핥기',
])
