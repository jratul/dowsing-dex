...
export const HG_STORY_FINAL_ROLES: RoleRow[] = [
  ...
  { pokemon: '헤라크로스', role: 'HG 전용 격투/벌레. 메가혼·인파이트·사이코커터. 레드 잠만보·에브이 처리' },
...
export const HG_STORY_MOVESETS: MoveSetSection[] = [
  ...
  },
  {
    pokemonId: 130,
    pokemon: '갸라도스',
    finalMoves: ['파도타기', '폭포오르기', '괴력', '아이언테일 / 얼어붙은바람'],
    moveTable: [
  ...
  },
  {
    pokemonId: 214,
    pokemon: '헤라크로스',
    finalMoves: ['메가혼', '인파이트', '사이코커터', '공중날기 / 독찌르기'],
    moveTable: [
      { move: '메가혼', how: 'Lv.55', usage: '노말 물리기. 친밀도 높을수록 강력. HG에서 유용' },
...
export const HG_STORY_JOHTO_GYMS: BossSection[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      { opponent: '고우스트 Lv.21 (고스트/독)', answer: '갸라도스 깨물어부수기 (악 2배)' },
      { opponent: '팬텀 Lv.25 (고스트/독)', answer: '에이스. 갸라도스 깨물어부수기 (악 2배). 넷 다 부유라 지진은 무효' },
  ...
  },
  {
    ...
    rows: [
      { opponent: '성원숭 Lv.29 (격투, 선두)', answer: '토게틱 에어슬래시 (비행 2배)' },
      { opponent: '강챙이 Lv.31 (물/격투)', answer: '전룡 10만볼트 (전기 2배) / 토게틱 에어슬래시' },
    ],
  },
  {
...
export const HG_STORY_KANTO_GYMS: BossSection[] = [
  ...
  },
  {
    ...
    note: '헤라크로스 인파이트/메가혼 또는 갸라도스 아이언테일. 에스퍼는 악/벌레에 약점.',
    rows: [
      { opponent: '에브이 Lv.53 (선두) · 마임맨 Lv.53 · 후딘 Lv.55', answer: '갸라도스 깨물어부수기 (악 2배) / 헤라크로스 메가혼 (벌레 2배)' },
    ],
  },
  {
...
export const HG_STORY_ELITE4: BossSection[] = [
  {
    ...
    rows: [
      { opponent: '네이티오 Lv.40 (선두) · 루주라 Lv.41 · 야도란 Lv.41 · 나시 Lv.41 · 네이티오 Lv.42', answer: '헤라크로스 메가혼 (벌레 2배) / 갸라도스 깨물어부수기 (악 2배)' },
    ],
  },
  {
  ...
  },
  {
    ...
    rows: [
      ...
      { opponent: '라플레시아 Lv.42 (풀/독) · 팬텀 Lv.45 (고스트/독)', answer: '블레이범 화염방사 (라플레시아에 불꽃 2배) / 갸라도스 깨물어부수기 (팬텀에 악 2배)' },
    ],
  },
]
