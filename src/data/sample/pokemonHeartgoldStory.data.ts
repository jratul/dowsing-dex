...
export const HG_STORY_KANTO_GYMS: BossSection[] = [
  ...
  },
  {
    ...
    rows: [
      { opponent: '에브이 Lv.53 (선두) · 마임맨 Lv.53 · 후딘 Lv.55', answer: '갸라도스 깨물어부수기 (악 2배) / 헤라크로스 메가폰 (벌레 2배)' },
    ],
  },
  {
  ...
  },
  {
    ...
    rows: [
      { opponent: '나시 Lv.55 (풀/에스퍼, 선두)', answer: '헤라크로스 메가폰 (벌레 4배!) / 블레이범 화염방사 (불꽃 2배)' },
...
export const HG_STORY_ELITE4: BossSection[] = [
  {
    ...
    rows: [
      { opponent: '네이티오 Lv.40 (선두) · 루주라 Lv.41 · 야도란 Lv.41 · 나시 Lv.41 · 네이티오 Lv.42', answer: '헤라크로스 메가폰 (벌레 2배) / 갸라도스 깨물어부수기 (악 2배)' },
    ],
  },
  {
...
export const HG_STORY_MOVE_NAMES: ReadonlySet<string> = new Set([
  ...
  '전기자석파', '폭포오르기', '화염자동차', '강철날개', '공중날기', '날개쉬기',
  '노래하기', '독찌르기', '락클라임', '바위깨기', '번개펀치', '불꽃세례',
  '빛의장막', '얼다바람', '얼음엄니', '이상한빛', '인파이트', '크로스촙',
  '파괴광선', '파도타기', '헤롱헤롱', '화염방사', '냉동빔', '눈보라',
  '메가폰', '박치기', '솔라빔', '용의춤', '최면술', '파동탄',
