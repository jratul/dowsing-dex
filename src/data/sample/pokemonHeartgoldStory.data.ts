...
export const HG_STORY_TM_NOTES = [
  ...
  '빛나는돌은 토게틱의 진화 아이템. 자연공원 포충대회 1위 상품 또는 특정 장소에서 획득 가능.',
]
...
export const HG_STORY_JOHTO_GYMS: BossSection[] = [
  ...
  },
  {
    ...
    note: '밀탱크(Lv.23)의 배북+몸통박치기가 매우 강하다. 헤라크로스 격투기 또는 토게키스 오라스피어로 처리. 백화점 5층 NPC와 슬리프를 주고 받는 암컷 알통몬도 유효 — 헤롱헤롱 무효 + 교환 보정으로 경험치가 빨리 쌓임. 호일 체육관에서 받은 연속자르기를 스라크나 헤라크로스에게 사전 배정해두면 밀탱크 처리에 도움이 된다.',
    rows: [
      { opponent: '밀탱크 (배북+몸통박치기)', answer: '헤라크로스 인파이트 / 토게키스 오라스피어 / 알통몬(교환) 크로스촙' },
    ],
  },
  {
    ...
    rows: [
      { opponent: '무우마·겐가', answer: '갸라도스 깨물어부수기(악 물리) / 블레이범 화염방사 / 야부엉 불면 특성으로 최면술 무효화' },
    ],
  },
  {
...
export const HG_STORY_ALT_TOGEKISS: AlternativeRow[] = [
  ...
  },
  {
    pokemonId: 80,
    pokemon: '야도란',
    role: '물/에스퍼 내구형 딜러. 야돈 Lv.37 진화. 파도타기+냉동빔+사이코키네시스로 목호·레드전 모두 대응. 갸라도스 대신 파도타기 담당 가능',
    obtainedAt: '야돈우물 (2관 이후, 이른 획득 가능)',
  },
  {
    pokemonId: 121,
    pokemon: '아쿠스타',
...
export const HG_STORY_CAUTIONS = [
  ...
  '토게키스 진화용 빛나는돌은 게임 내 소수 획득처에서 구한다. 자연공원 포충대회 1위 상품으로도 획득 가능.',
...
export const HG_STORY_EVOLUTION_TIMING: EvolutionTimingRow[] = [
  ...
  },
  {
    ...
    note: '빛나는돌은 자연공원 포충대회 1위 보상 또는 특정 NPC 증정. 기술 가르침으로 에어슬래시·오라스피어 보완 가능. 레벨 제한 없이 사용 가능하므로 획득 즉시 진화해도 무관.',
  },
  {
