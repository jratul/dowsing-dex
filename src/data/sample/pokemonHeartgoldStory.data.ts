...
export const HG_STORY_TM_NOTES = [
  ...
  '빛의돌은 토게틱의 진화 아이템. 자연공원 곤충채집 대회 1위 상품 또는 특정 장소에서 획득 가능.',
]
...
export const HG_STORY_JOHTO_GYMS: BossSection[] = [
  {
    title: '도라지체육관 (비행 타입)',
    note: '전룡의 10만볼트 또는 토게키스 파동탄로 안정 처리.',
    rows: [
      { opponent: '갈모매·파이어보', answer: '전룡 10만볼트 / 토게키스 파동탄' },
    ],
  },
  {
  ...
  },
  {
    ...
    rows: [
      { opponent: '밀탱크 (배북+몸통박치기)', answer: '헤라크로스 인파이트 / 토게키스 파동탄 / 알통몬(교환) 크로스촙' },
    ],
  },
  {
...
export const HG_STORY_KANTO_GYMS: BossSection[] = [
  ...
  {
    title: '연분홍체육관 (독 타입)',
    note: '블레이범 지진 또는 토게키스 파동탄로 처리.',
    rows: [
      { opponent: '독침붕·아포켈', answer: '블레이범 지진 / 토게키스 파동탄' },
    ],
  },
  {
...
export const HG_STORY_ELITE4: BossSection[] = [
  ...
  {
    title: '사천왕 카렌 (악 타입)',
    note: '블레이범 화염방사·헤라크로스 격투기·토게키스 파동탄로 처리.',
    rows: [
      { opponent: '핫삼·블래키·독수리·악비아르·블래독', answer: '블레이범 화염방사 / 토게키스 파동탄' },
    ],
  },
]
