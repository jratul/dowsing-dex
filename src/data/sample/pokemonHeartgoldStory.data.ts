...
export const HG_STORY_FINAL_ROLES: RoleRow[] = [
  ...
  { pokemon: '헤라크로스', role: 'HG 전용 격투/벌레. 인파이트(Lv.37)가 주력이고 그 전에는 깨뜨리다(Lv.19). 벌레 STAB인 메가혼은 Lv.55라 관동 이후에야 들어온다. 레드 잠만보 처리' },
...
export const HG_STORY_MOVESETS: MoveSetSection[] = [
  {
    pokemonId: 157,
    pokemon: '블레이범',
    finalMoves: ['화염방사', '솔라빔 / 번개펀치', '지진', '화염바퀴 / 스피드스타'],
    moveTable: [
  ...
  },
  {
    pokemonId: 130,
    pokemon: '갸라도스',
    finalMoves: ['파도타기', '폭포오르기', '괴력', '물기 / 얼음엄니'],
    moveTable: [
  ...
  },
  {
    pokemonId: 214,
    pokemon: '헤라크로스',
    finalMoves: ['메가혼(Lv.55)', '인파이트(Lv.37)', '스톤에지(TM71)', '제비반환(Lv.13)'],
    moveTable: [
...
export const HG_STORY_TM_NOTES = [
  ...
  'HGSS에서 빛의돌은 포스트게임(록클라임 이후 자연공원 접근 가능 시점)에서만 입수 가능. 스토리 중 토게키스 진화 불가.',
]
...
export const HG_STORY_JOHTO_GYMS: BossSection[] = [
  ...
  },
  {
    ...
    rows: [
      { opponent: '스라크 Lv.17 (벌레/비행, 선두)', answer: '마그케인 불꽃세례 (불꽃 2배!). 에이스가 먼저 나온다' },
  ...
  },
  {
    ...
    note: '고스트 타입에 노말·격투 무효. 갸라도스 물기(Lv.20)(악 타입 물리기)가 HGSS에서 가장 안정적. 블레이범 화염방사로도 처리 가능. 야부엉의 불면 특성은 유빈의 최면술을 원천 차단해준다.',
    rows: [
      { opponent: '고오스 Lv.21 (고스트/독, 선두)', answer: '마그케인 화염방사 (중립, 레벨 우위)' },
      { opponent: '고우스트 Lv.21 (고스트/독)', answer: '갸라도스 물기(Lv.20) (악 2배)' },
      { opponent: '팬텀 Lv.25 (고스트/독)', answer: '에이스. 갸라도스 물기(Lv.20) (악 2배). 넷 다 부유라 지진은 무효' },
      { opponent: '고우스트 Lv.23 (고스트/독)', answer: '화염방사로 마무리' },
    ],
  },
  {
    title: '진청체육관 사도 (격투 타입)',
    note: '격투는 비행·에스퍼에 약점. 토게틱 제비반환(TM40)나 마그케인 불꽃세례로 처리. 강챙이(물/격투)는 아쿠아테일 주의.',
    rows: [
      { opponent: '성원숭 Lv.29 (격투, 선두)', answer: '토게틱 제비반환(TM40) (비행 2배)' },
      { opponent: '강챙이 Lv.31 (물/격투)', answer: '전룡 10만볼트 (전기 2배) / 토게틱 제비반환(TM40)' },
    ],
  },
  {
  ...
  },
  {
    ...
    rows: [
      { opponent: '쥬쥬 Lv.30 (물, 선두)', answer: '전룡 10만볼트 (전기 2배). 두꺼운지방이라 불꽃·얼음은 반감' },
      { opponent: '쥬레곤 Lv.32 (물/얼음)', answer: '전룡 10만볼트 (전기 2배) / 헤라크로스 인파이트 (격투 2배)' },
  ...
  },
  {
    ...
    rows: [
      { opponent: '갸라도스 Lv.38 (물/비행, 선두)', answer: '전룡 10만볼트 (전기 4배!). 위협으로 이쪽 물리 공격이 1랭크 내려간다' },
      { opponent: '신뇽 Lv.38 x2 (드래곤)', answer: '라프라스 얼음기둥 (얼음 2배)' },
      { opponent: '킹드라 Lv.41 (물/드래곤)', answer: '4세대엔 페어리가 없어 약점이 드래곤뿐 — 얼음·전기 모두 1배다. 중립 화력으로 밀어야 한다' },
    ],
  },
]
...
export const HG_STORY_KANTO_GYMS: BossSection[] = [
  {
    ...
    rows: [
      { opponent: '데구리 Lv.51 (선두) · 뿔카노 Lv.51 · 투구푸스 Lv.52 · 암스타 Lv.53 · 롱스톤 Lv.54', answer: '갸라도스 파도타기 — 데구리·롱스톤(바위/땅)에 4배' },
    ],
  },
  {
    title: '블루체육관 이슬 (물 타입)',
    ...
    rows: [
      { opponent: '골덕 Lv.49 (선두) · 누오 Lv.49 · 라프라스 Lv.52 · 아쿠스타 Lv.54', answer: '전룡 10만볼트 — 다만 누오(물/땅)는 전기 무효라 풀 기술로 처리' },
    ],
  },
  {
    ...
    rows: [
      { opponent: '라이츄 Lv.51 (선두) · 붐볼 Lv.47 x2 · 레어코일 Lv.47 · 에레브 Lv.53', answer: '블레이범 지진 (땅 2배, 레어코일은 4배)' },
    ],
  },
  {
    ...
    rows: [
      { opponent: '솜솜코 Lv.51 (선두) · 덩쿠리 Lv.52 · 우츠보트 Lv.56 · 아르코 Lv.56', answer: '블레이범 화염방사 (불꽃 2배) / 크로뱃 에어슬래시' },
    ],
  },
  {
    ...
    rows: [
      { opponent: '크로뱃 Lv.47 (선두) · 또도가스 Lv.44 · 아리아도스 Lv.47 x2 · 도나리 Lv.50', answer: '블레이범 지진 (독에 2배) — 단 선두 크로뱃(독/비행)은 땅 무효다. 크로뱃엔 전룡 10만볼트' },
    ],
  },
  {
    title: '노랑체육관 초련 (에스퍼 타입)',
    note: '갸라도스 물기(Lv.20)가 안전하다. 헤라크로스는 격투라 에스퍼 기술에 2배로 맞고, 벌레 STAB인 메가혼도 Lv.55가 되어야 들어온다.',
    rows: [
      { opponent: '에브이 Lv.53 (선두) · 마임맨 Lv.53 · 후딘 Lv.55', answer: '갸라도스 물기(Lv.20) (악 2배). 헤라크로스가 Lv.55를 넘겼다면 메가혼(벌레 2배)도 가능하지만, 격투라 사이코키네시스에 2배로 맞는 점을 감안한다' },
    ],
  },
  {
    ...
    rows: [
      { opponent: '마그카르고 Lv.54 (선두) · 마그마 Lv.54 · 날쌩마 Lv.59', answer: '갸라도스 파도타기 — 마그카르고(불꽃/바위)에는 물이 4배' },
    ],
  },
  {
    ...
    rows: [
      { opponent: '나시 Lv.55 (풀/에스퍼, 선두)', answer: '헤라크로스 메가혼 (벌레 4배!) / 블레이범 화염방사 (불꽃 2배)' },
      { opponent: '갸라도스 Lv.52 (물/비행)', answer: '전룡 10만볼트 (전기 4배!)' },
      { opponent: '괴력몬 Lv.56 (격투)', answer: '크로뱃 에어슬래시 (비행 2배)' },
      { opponent: '윈디 Lv.58 (불꽃)', answer: '갸라도스 파도타기 (물 2배) / 라프라스' },
      { opponent: '코뿌리 Lv.58 (땅/바위)', answer: '갸라도스 파도타기 (물 4배!) / 라프라스 파도타기' },
      { opponent: '피죤투 Lv.60 (노말/비행)', answer: '전룡 10만볼트 (전기 2배) / 라프라스 얼음기둥' },
    ],
  },
]
...
export const HG_STORY_ELITE4: BossSection[] = [
  {
    title: '사천왕 일목 (에스퍼 타입)',
    note: '첫 리그는 Lv.40~50 구간이다. 전룡 10만볼트와 블레이범 화염방사 두 마리로 사실상 끝난다. 헤라크로스는 메가혼이 Lv.55라 아직 없고, 격투라 사이코키네시스에 2배로 맞으니 내지 않는다.',
    rows: [
      { opponent: '네이티오 Lv.40 (선두) · 루주라 Lv.41 · 야도란 Lv.41 · 나시 Lv.41 · 네이티오 Lv.42', answer: '전룡 10만볼트로 네이티오 x2와 야도란(물/에스퍼)을 맡고, 루주라·나시는 블레이범 화염방사. 야도란은 망각술로 특방을 올리니 먼저 세게 때린다. 갸라도스 물기(Lv.20)는 백업' },
    ],
  },
  {
    ...
    rows: [
      { opponent: '아리아도스 Lv.40 (선두) · 도나리 Lv.41 · 질뻐기 Lv.42 · 쏘콘 Lv.43 · 크로뱃 Lv.44', answer: '독·벌레 위주다. 블레이범 화염방사 (벌레 타입에 2배) — 크로뱃(독/비행)은 땅 무효라 지진이 안 통한다' },
    ],
  },
  {
    title: '사천왕 시바 (격투 타입)',
    ...
    rows: [
      { opponent: '카포에라 Lv.42 (선두) · 시라소몬 Lv.42 · 홍수몬 Lv.42 · 괴력몬 Lv.46 (격투)', answer: '크로뱃 에어슬래시 (비행 2배)' },
      { opponent: '롱스톤 Lv.43 (바위/땅)', answer: '갸라도스 파도타기 (물 4배!)' },
    ],
  },
  {
    title: '사천왕 카렌 (악 타입)',
    ...
    rows: [
      { opponent: '블래키 Lv.42 (악, 선두) · 니로우 Lv.44 (악/비행) · 헬가 Lv.47 (악/불꽃)', answer: '헤라크로스 인파이트 (격투 2배). 악 타입이라 에스퍼는 무효' },
      { opponent: '라플레시아 Lv.42 (풀/독) · 팬텀 Lv.45 (고스트/독)', answer: '블레이범 화염방사 (라플레시아에 불꽃 2배) / 갸라도스 물기(Lv.20) (팬텀에 악 2배)' },
    ],
  },
]
...
export const HG_STORY_CHAMPION: BossSection = {
  title: '챔피언 목호 (드래곤 타입)',
  note: '목호 파티는 갸라도스 Lv.46(선두)·망나뇽 Lv.49 x2·프테라 Lv.48·리자몽 Lv.48·망나뇽 Lv.50. 킹드라는 들어 있지 않다. 망나뇽 3마리는 얼음 4배라 라프라스가 핵심이고, 갸라도스는 전룡 전기기로 처리한다.',
  rows: [
    { opponent: '갸라도스 Lv.46 (물/비행, 선두)', answer: '전룡 10만볼트 (전기 4배!)' },
    { opponent: '망나뇽 Lv.49 x2 (드래곤/비행)', answer: '라프라스 얼음기둥 (얼음 4배!)' },
    { opponent: '프테라 Lv.48 (바위/비행)', answer: '갸라도스 파도타기 (물 2배) / 라프라스 얼음기둥 (얼음 2배)' },
    { opponent: '리자몽 Lv.48 (불꽃/비행)', answer: '갸라도스 파도타기 (물 2배) / 전룡 10만볼트 (전기 2배)' },
    { opponent: '망나뇽 Lv.50 (드래곤/비행)', answer: '라프라스 얼음기둥 (얼음 4배!)' },
  ],
}
...
export const HG_STORY_RED: BossSection = {
  ...
  rows: [
    ...
    { opponent: '에브이 Lv.82 (에스퍼)', answer: '헤라크로스 인파이트 / 갸라도스 물기(Lv.20)' },
...
export const HG_STORY_CAUTIONS = [
  ...
  '토게키스 진화에 필요한 빛의돌은 HGSS에서 포스트게임(록클라임 이후 자연공원 접근 가능 시점) 이전에 입수할 수 없다. 스토리 중에는 크로뱃을 비행 타입으로 운용한다.',
 ...
 */
export const HG_STORY_MOVE_NAMES: ReadonlySet<string> = new Set([
  '깨물어부수기', '브레이브버드', '크로스포이즌', '10만볼트', '몸통박치기', '바다회오리',
  '사이코커터', '스피드스타', '아이언테일', '아쿠아테일', '에어슬래시', '연속자르기',
  '전기자석파', '폭포오르기', '화염바퀴', '강철날개', '공중날기', '날개쉬기',
  '노래하기', '스톤에지', '록클라임', '바위깨기', '번개펀치', '불꽃세례',
  '빛의장막', '얼어붙은바람', '얼음엄니', '이상한빛', '인파이트', '크로스촙',
  '파괴광선', '파도타기', '헤롱헤롱', '화염방사', '냉동빔', '눈보라',
  '메가혼', '박치기', '솔라빔', '용의춤', '최면술', '파동탄',
  '풀베기', '플래시', '회오리', '괴력', '물기', '배북',
  '번개', '유턴', '지진',
])
