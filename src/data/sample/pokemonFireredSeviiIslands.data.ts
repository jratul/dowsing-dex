...
export const SEVII_STORY_RAINBOW_STEPS: StageRow[] = [
  ...
  },
  {
    ...
    note: '비밀번호는 상징의 숲 주변과 아스카나 유적 구역에서 각각 얻는다.',
  },
  {
    step: '⑩ 로켓단 창고 돌파',
    island: '5의 섬',
...
export const SEVII_CATCH_TABLE: IslandCatchRow[] = [
  ...
  { island: '1의 섬', location: '보물의 해변 (좋은낚싯대)', pokemonId: 116, pokemon: '쏘드라', note: '물 타입. 시드라로 진화. 대단한낚싯대를 쓰면 시드라가 직접 나온다.' },
  { island: '1의 섬', location: '저녁노을길', pokemonId: 78, pokemon: '날쌩마', note: '불꽃 타입. 포니타의 진화형으로 스피드가 높다.' },
  { island: '2의 섬', location: '가장자리 곶 (낡은낚싯대)', pokemonId: 129, pokemon: '잉어킹', note: '갸라도스 진화용. 대단한낚싯대로는 갸라도스가 직접 나온다.' },
  { island: '3의 섬', location: '3섬 항구', pokemonId: 206, pokemon: '노고치', note: '노말 타입. 내구가 높아 상태이상 걸기 좋다.' },
  { island: '4의 섬', location: '얼어붙은 폭포의 동굴', pokemonId: 220, pokemon: '꾸꾸리', note: '얼음·땅 타입. 메꾸리로 진화. 내구형 얼음 담당.' },
  { island: '4의 섬', location: '얼어붙은 폭포의 동굴', pokemonId: 225, pokemon: '딜리버드', note: '얼음/비행. 종족값은 낮지만 이 동굴에서만 나온다.' },
  { island: '4의 섬', location: '얼어붙은 폭포의 동굴', pokemonId: 215, pokemon: '포푸니', note: '악/얼음. 공격이 높아 실전 투입이 가능하다.' },
  { island: '5의 섬', location: '5의섬 공터', pokemonId: 52, pokemon: '나옹', note: '노말 타입. 페르시온으로 진화. 노름꾼 특성으로 돈을 번다.' },
  { island: '5의 섬', location: '5의섬 공터', pokemonId: 187, pokemon: '통통코', note: '풀/비행. 두솜코·솜솜코로 진화하며 보조기가 많다.' },
  { island: '6의 섬', location: '상징의 숲', pokemonId: 214, pokemon: '헤라크로스', note: '벌레/격투. 이 숲의 최대 수확. 공격 125로 즉시 주력이 된다.' },
  { island: '6의 섬', location: '상징의 숲', pokemonId: 167, pokemon: '페이검', note: '벌레/독. 아리아도스로 진화.' },
  ...
  { island: '7의 섬', location: '아스카나의 석실', pokemonId: 201, pokemon: '안농', note: '에스퍼 타입. 아스카나 유적 열쇠로 봉인을 풀면 석실에 들어갈 수 있다.' },
]
...
export const SEVII_ITEM_TABLE: IslandItemRow[] = [
  ...
  { island: '7의 섬', location: '아스카나 유적', item: '아스카나 유적 열쇠', note: '아스카나 유적에서 암흑의 박스 7개를 밀어 열쇠 모양을 만들면 아스카나 유적이 열린다.' },
]
...
export const SEVII_ROCKET_WAREHOUSE: RocketWarehouseRow[] = [
  ...
  { task: '비밀번호 2 획득', detail: '아스카나 유적 구역 NPC와 대화해 두 번째 비밀번호를 얻는다.' },
...
export const SEVII_UNOWN_NOTE = [
  '7의 섬 아스카나 유적에서 암흑의 박스 7개를 밀어 열쇠 모양을 완성하면 아스카나 유적이 열린다.',
