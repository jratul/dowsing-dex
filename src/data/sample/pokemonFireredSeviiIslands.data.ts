...
export const SEVII_CATCH_TABLE: IslandCatchRow[] = [
  ...
  { island: '3의 섬', location: '딸기숲', pokemonId: 79, pokemon: '야돈', note: '물·에스퍼 타입. 야도란 대체 가능. 에스퍼 타입 보강 용도.' },
  { island: '3의 섬', location: '딸기숲', pokemonId: 46, pokemon: '파라스', note: '벌레·풀 타입. 파라섹트로 진화. 포획률이 낮아 주의 필요.' },
  { island: '4의 섬', location: '얼음 동굴', pokemonId: 124, pokemon: '루주라', note: '얼음·에스퍼 타입. 냉동빔과 에스퍼 기술 모두 운용 가능.' },
  { island: '4의 섬', location: '얼음 동굴', pokemonId: 220, pokemon: '꾸꾸리', note: '얼음·땅 타입. 메꾸리로 진화. 내구형 얼음 타입으로 활용 가능.' },
  ...
  { island: '7의 섬', location: '탄보비 유적', pokemonId: 201, pokemon: '안농', note: '에스퍼 타입. 탄보비 열쇠로 봉인 해제 후 각 방에서 형태별 포획.' },
