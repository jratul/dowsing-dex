...
export const SEVII_STORY_TRIPASS_STEPS: StageRow[] = [
  ...
  },
  {
    step: '⑤ 나무열매 숲 탐험',
    island: '3의 섬',
    action: '나무열매 숲 안쪽에서 최면포켓몬(수면!)에게 붙잡힌 루리를 구출',
...
export const SEVII_STORY_RAINBOW_STEPS: StageRow[] = [
  {
    step: '⑦ 4의 섬 방문',
    island: '4의 섬',
    action: '얼어붙은 폭포의 동굴 탐험 → HM07 폭포오르기 획득 → 로렐 이벤트',
    note: '얼어붙은 폭포의 동굴 안에서 팀 로켓과 싸우는 로렐(사천왕)을 돕는다. 이후 폭포오르기 사용 가능.',
  },
  {
    step: '⑧ 6의 섬 탐험',
    island: '6의 섬',
    action: '상징의 숲 진입 → 내부 수수께끼 해결 → 사파이어석 발견',
  ...
  },
  {
    ...
    note: '비밀번호는 상징의 숲 주변과 아스카나 유적 구역 구역에서 각각 얻는다.',
  },
  {
    step: '⑩ 로켓단 창고 돌파',
    island: '5의 섬',
...
export const SEVII_CATCH_TABLE: IslandCatchRow[] = [
  { island: '1의 섬', location: '횃불산', pokemonId: 218, pokemon: '마그마그', note: '불꽃 타입. 마그카르고로 진화. 불꽃 타입 필요 시 편의.' },
  { island: '1의 섬', location: '횃불산', pokemonId: 219, pokemon: '마그카르고', note: '마그마그의 진화형. 횃불산 깊은 곳에서 등장.' },
  { island: '1의 섬', location: '보물의 해변 낚시', pokemonId: 116, pokemon: '쏘드라', note: '물·독 타입. 가시해마로 진화. 전기 약점 주의.' },
  { island: '2의 섬', location: '가장자리 곶 낚시', pokemonId: 129, pokemon: '잉어킹', note: '갸라도스 진화용. 이미 갸라도스가 있다면 불필요.' },
  { island: '3의 섬', location: '나무열매 숲', pokemonId: 79, pokemon: '야돈', note: '물·에스퍼 타입. 야도란 대체 가능. 에스퍼 타입 보강 용도.' },
  { island: '3의 섬', location: '나무열매 숲', pokemonId: 46, pokemon: '파라스', note: '벌레·풀 타입. 파라섹트로 진화. 포획률이 낮아 주의 필요.' },
  { island: '4의 섬', location: '얼어붙은 폭포의 동굴', pokemonId: 124, pokemon: '루주라', note: '얼음·에스퍼 타입. 냉동빔과 에스퍼 기술 모두 운용 가능.' },
  { island: '4의 섬', location: '얼어붙은 폭포의 동굴', pokemonId: 220, pokemon: '꾸꾸리', note: '얼음·땅 타입. 메꾸리로 진화. 내구형 얼음 타입으로 활용 가능.' },
  { island: '5의 섬', location: '5의섬 공터', pokemonId: 52, pokemon: '나옹', note: '노말 타입. 페르시온으로 진화. 노름꾼 특성으로 아이템 수집에 활용 가능.' },
  { island: '5의 섬', location: '5의섬 공터', pokemonId: 163, pokemon: '부우부', note: '노말 타입. 야부링으로 진화. 고속이동 활용도 있음.' },
  { island: '6의 섬', location: '상징의 숲·낚시', pokemonId: 138, pokemon: '암나이트', note: '바위·물 타입 화석 포켓몬. 암스타로 진화.' },
  { island: '6의 섬', location: '상징의 숲·낚시', pokemonId: 140, pokemon: '투구', note: '바위·물 타입 화석 포켓몬. 투구푸스로 진화.' },
  { island: '7의 섬', location: '아스카나 유적', pokemonId: 201, pokemon: '안농', note: '에스퍼 타입. 아스카나 유적 열쇠로 봉인 해제 후 각 방에서 형태별 포획.' },
...
export const SEVII_ITEM_TABLE: IslandItemRow[] = [
  ...
  { island: '3의 섬', location: '나무열매 숲 클리어 보상', item: '대단한낚싯대', note: '루리를 구한 후 마을에서 노인 NPC에게 입수. 강한 낚시 포켓몬 포획 가능.' },
  { island: '4의 섬', location: '얼어붙은 폭포의 동굴', item: 'HM07 폭포오르기', note: '얼어붙은 폭포의 동굴 내부에서 입수. 이후 폭포를 오르는 탐험이 가능해진다.' },
  { island: '5의 섬', location: '로켓단 창고', item: '사파이어석', note: '창고 최심부에서 회수. 셀리오에게 전달하면 전국도감이 해제된다.' },
  { island: '6의 섬', location: '상징의 숲', item: '사파이어석(발견 후 탈취)', note: '수수께끼 해결 후 발견되지만 팀 로켓이 즉시 가져간다.' },
  { island: '7의 섬', location: '아스카나 유적 구역', item: '아스카나 유적 열쇠', note: '아스카나 유적 구역에서 암흑의 박스 7개를 밀어 열쇠 모양을 만들면 아스카나 유적이 열린다.' },
]
...
export const SEVII_ROCKET_WAREHOUSE: RocketWarehouseRow[] = [
  { task: '사전 준비', detail: '6의 섬 상징의 숲을 먼저 클리어해 팀 로켓에게 사파이어석을 탈취당한다.' },
  { task: '비밀번호 1 획득', detail: '상징의 숲 입구 쪽 NPC와 대화해 첫 번째 비밀번호를 얻는다.' },
  { task: '비밀번호 2 획득', detail: '아스카나 유적 구역 구역 NPC와 대화해 두 번째 비밀번호를 얻는다.' },
