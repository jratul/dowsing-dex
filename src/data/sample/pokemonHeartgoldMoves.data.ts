...
export const HGM_TIMINGS: PokemonTiming[] = [
  ...
  },
  {
    ...
    moves: [
      { level: 13, move: '제비반환' },
      { level: 19, move: '깨트리다', key: true },
      { level: 37, move: '인파이트', key: true },
      { level: 55, move: '메가폰', key: true },
    ],
    advice: [
      '중반까지 깨트리다로 버티다가 Lv.37 인파이트로 교체하면 된다.',
      'Lv.55 메가폰은 벌레 타입 최고 위력기(120)라 최종 세팅까지 남긴다.',
    ],
    wasteWarning: 'TM31 깨트리다 — Lv.19에 자력으로 배운다.',
  },
  {
    pokemonId: 157,
    pokemon: '블레이범',
...
export const HGM_CHECKLIST: { group: string; items: string[] }[] = [
  {
    ...
    items: [
      ...
      '라프라스 Lv.32 냉동빔',
      '헤라크로스 Lv.19 깨트리다 · Lv.37 인파이트 · Lv.55 메가폰',
      '블레이범 Lv.42 화염방사',
