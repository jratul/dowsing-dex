...
export const HGS_STONES: StoneEntry[] = [
  {
    ...
    acquisitions: [
      ...
      },
      {
        label: '이수재의 할아버지',
        type: 'npc',
        detail: '관동 25번도로 끝 집(세르울리안 곶). 삐삐를 보여주면 달의돌 1개를 받는다.',
        once: true,
      },
      {
        label: '에메랄드 산 월요일 밤 이벤트',
        type: 'event',
        detail: '관동 에메랄드 산(Mt. Moon)을 월요일 밤에 방문하면 삐삐들이 춤을 추고, 광장 중앙에서 달의돌 1개를 발견할 수 있다. 사천왕 클리어 후 관동 이동 가능.',
        once: true,
      },
      {
        label: '야생 삐삐 지니기',
