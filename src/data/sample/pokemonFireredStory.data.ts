...
export const FIRERED_STORY_MOVESETS: MoveSetSection[] = [
  ...
  },
  {
    ...
    notes: [
      '가장 추천하는 진화 타이밍은 이브이 레벨 30 물기 습득 후 천둥의돌을 사용하는 것이다.',
...
export const FIRERED_STORY_TRADE_EVO_TABLE: TradeEvoRow[] = [
  ...
  },
  {
    ...
    timing: '왕의징표석 지참 후 야도란 교환 (Lv.37 이후)',
    note: '야도킹은 물·에스퍼 복합. 왕의징표석 필요 (입수 경로 한정적). 느린 스피드가 단점. 라프라스·나시와 역할 중복으로 우선순위 낮음',
  },
  {
    pokemonId: 212,
    before: '스라크',
    after: '핫삼',
    catchLocation: '스라크: 사파리존 야생 / 파이어레드 단독 입수는 제한적',
    timing: '메탈코트 지참 후 교환 즉시 가능',
    note: '핫삼은 벌레·강철 복합 탱커. 메탈코트 필요 (입수 경로 한정). 높은 방어력으로 사천왕 안정 운용 가능',
  },
]
