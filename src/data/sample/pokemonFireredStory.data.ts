...
export const FIRERED_STORY_STONE_EVO_TABLE: StoneEvoRow[] = [
  ...
  { pokemonId: 71, before: '우츠보', after: '우츠보트', stone: '리프의돌', available: '리그 교환 필요', timing: '우츠보 Lv.38 잎날가르기 후 (리프그린 기준)', reason: '파이어레드에서는 뚜벅쵸 계열 미출현. 리프그린에서 교환 필요' },
  // 물의돌
...
export const FIRERED_STORY_TRADE_EVO_TABLE: TradeEvoRow[] = [
  {
    ...
    before: '윤겔라',
    after: '후딘',
    catchLocation: '캐이시: 3번도로 (Lv.11~15)',
    timing: '윤겔라 Lv.16 이후 즉시 교환 권장',
    note: '후딘은 스피드·특수공격 최상급. 나시 대체 에스퍼 딜러. 3세대 기준 특수(에스퍼·냉동빔·10만볼트) 중심 운용',
  },
  {
    pokemonId: 68,
    before: '알통몬',
    after: '괴력몬',
    catchLocation: '알통몬: 5·25번도로 직접 포획 가능',
    timing: '알통몬 Lv.36 역습 습득 후 권장',
    note: '3세대 물리 격투 딜러. 잠만보와 역할 일부 중복이지만 격투 타입 상성 커버. 괴력(HM04) 담당 겸용 가능',
  },
  {
    pokemonId: 94,
    before: '고우스트',
    after: '팬텀',
    catchLocation: '고우스트: 포켓몬타워 (Lv.20~25)',
    timing: '고우스트 Lv.25 이후 즉시 교환 가능',
    note: '팬텀은 고스트·독 복합 + 부유 특성. 이 공략에서는 잠만보 섀도볼이 고스트 역할 담당하므로 중복 가능',
  },
  {
    pokemonId: 76,
    before: '데구리',
    after: '딱구리',
    catchLocation: '꼬마돌: 돌산터널 1층 / 데구리: 승리로드 등',
    timing: '데구리 확보 즉시 교환 가능',
    note: '딱구리는 바위·땅 복합 탱커. 이 공략에서는 니드킹이 땅 타입 주력이라 역할 중복. 단단한 방어력이 장점',
  },
  {
    pokemonId: 199,
    before: '야도란',
    after: '야도킹',
    catchLocation: '야돈: 홍련섬 주변 낚시 / 야도란: Lv.37 자동 진화',
    timing: '킹의돌 지참 후 야도란 교환 (Lv.37 이후)',
    note: '야도킹은 물·에스퍼 복합. 킹의돌 필요 (입수 경로 한정적). 느린 스피드가 단점. 라프라스·나시와 역할 중복으로 우선순위 낮음',
  },
  {
    pokemonId: 212,
    before: '배루키',
    after: '강철톤',
    catchLocation: '배루키: 사파리존 야생 / 파이어레드 단독 입수는 제한적',
    timing: '메탈코트 지참 후 교환 즉시 가능',
    note: '강철톤은 강철·벌레 복합 탱커. 메탈코트 필요 (입수 경로 한정). 높은 방어력으로 사천왕 안정 운용 가능',
  },
]
