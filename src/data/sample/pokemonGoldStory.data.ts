...
export const GOLD_STORY_MOVESETS: MoveSetSection[] = [
  ...
  },
  {
    pokemonId: 130,
    pokemon: '갸라도스',
    finalMoves: ['파도타기', '괴력', '폭포오르기', '얼어붙은바람 / 용의숨결 / 은혜갚기'],
    moveTable: [
      ...
      { move: '얼어붙은바람', how: 'TM16', usage: '목호 망나뇽 견제 보조' },
    ...
    notes: [
      ...
      'TM16 얼어붙은바람은 황토마을 체육관 관장 류옹 격파 보상이다.',
      '갸라도스는 2세대에서 얼어붙은바람을 배울 수 있다.',
      '목호전의 핵심 드래곤 처리는 윤겔라 냉동펀치가 담당하므로, 갸라도스의 얼어붙은바람은 보조 용도다.',
    ],
  },
  {
    pokemonId: 64,
...
export const GOLD_STORY_TM_PRIORITY: TmRow[] = [
  ...
  { tm: 'TM16', move: '얼어붙은바람', target: '갸라도스', location: '황토마을 체육관, 류옹 격파 보상', priority: '중간', desc: '목호 망나뇽 상대로 보조 견제 가능' },
...
export const GOLD_STORY_TM_NOTES = [
  'TM16 얼어붙은바람은 황토마을 체육관 관장 류옹 격파 보상이다.',
  '갸라도스는 2세대에서 TM16 얼어붙은바람을 배울 수 있다.',
  '얼어붙은바람은 위력은 낮지만 스피드 하락 효과가 있어 목호전 망나뇽 상대로 보조 역할을 수행할 수 있다.',
  '목호의 망나뇽 처리는 기본적으로 윤겔라의 냉동펀치가 담당한다.',
  '갸라도스의 얼어붙은바람은 윤겔라가 쓰러졌을 때를 대비한 백업 카드로 본다.',
...
export const GOLD_STORY_BOSSES: BossSection[] = [
  ...
  },
  {
    title: '사천왕 독수',
    rows: [
      { opponent: '아리아도스 Lv.40 (선두)', answer: '블레이범 화염방사 (벌레에 2배)' },
  ...
  },
  {
    title: '사천왕 시바',
    rows: [
      { opponent: '카포에라 Lv.42 (선두)', answer: '윤겔라 사이코키네시스 (에스퍼 2배) / 크로뱃 비행 기술' },
      { opponent: '시라소몬 Lv.42', answer: '윤겔라 사이코키네시스 / 크로뱃' },
      { opponent: '홍수몬 Lv.42', answer: '윤겔라 사이코키네시스 / 크로뱃' },
      { opponent: '롱스톤 Lv.43 (바위/땅)', answer: '갸라도스 파도타기 (물 4배!) / 우츠동 풀 기술 (4배)' },
      { opponent: '괴력몬 Lv.46', answer: '윤겔라 사이코키네시스 / 크로뱃' },
    ],
  },
  {
    title: '사천왕 카렌',
 ...
 */
export const GOLD_STORY_MOVE_NAMES: ReadonlySet<string> = new Set([
  '사이코키네시스', '나이트헤드', '바다회오리', '스피드스타', '잎날가르기', '전기자석파',
  '폭포오르기', 'HP회복', '공중날기', '구멍파기', '날개치기', '냉동펀치',
  '덩굴채찍', '리플렉터', '번개펀치', '불꽃펀치', '불대문자', '빛의장막',
  '수면가루', '얼어붙은바람', '오물폭탄', '용의숨결', '은혜갚기', '이상한빛',
  '저리가루', '파도타기', '화염방사', '꿈먹기', '눈보라', '섀도볼',
  '용해액', '잠자기', '최면술', '풀베기', '플래시', '회오리',
  '괴력', '물기', '번개', '분화', '저주', '지진',
])
