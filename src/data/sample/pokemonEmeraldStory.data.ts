...
const EMERALD_GYM_ROWS_TEMPLATE = {
  g1: { title: '1관 - 폴보로체육관 (바위 타입)', note: '꼬마돌 x2 · 코코파스. 꼬마돌은 바위/땅이라 물·풀이 4배.' },
  g2: { title: '2관 - 등대마을체육관 (격투 타입)', note: '알통몬·요가랑·마크탕. 비행·에스퍼에 약점. 요가랑은 격투/에스퍼라 에스퍼가 반감된다.' },
  g3: { title: '3관 - 물가시티체육관 (전기 타입)', note: '찌리리공·썬더라이·레어코일·썬더볼트. 땅 기술이 유효하고, 레어코일(전기/강철)은 땅이 4배다.' },
  g4: { title: '4관 - 라바시티체육관 (불꽃 타입)', note: '둔타·마그마그·폭타·코터스. 둔타와 폭타는 불꽃/땅이라 물이 4배.' },
  g5: { title: '5관 - 페탈버그체육관 선우 (노말 타입)', note: '주인공 아버지의 노말 파티 — 얼루기·발바로·직구리·게을킹. 전원 격투 2배, 고스트 무효.' },
  g6: { title: '6관 - 포트리체육관 (비행 타입)', note: '파비코·트로피우스·패리퍼·무장조·파비코리. 패리퍼는 전기 4배, 트로피우스·파비코리는 얼음 4배.' },
  g7: { title: '7관 - 모스딥체육관 (에스퍼 타입)', note: '점토도리·네이티오·루나톤·솔록 더블배틀. 악·고스트가 전원에게 2배. 점토도리는 전기 무효.' },
  g8: { title: '8관 - 수도포리스체육관 후안 (물 타입)', note: '에메랄드 전용 관장. 사랑동이·메깅·씨레오·가재장군·킹드라. 메깅은 전기 무효(풀 4배), 킹드라는 약점이 드래곤뿐이다.' },
}
...
const ACHAMO_GUIDE: StarterGuideData = {
  ...
  champion: {
    title: '챔피언 미라 (물 타입)',
    note: '에메랄드 전용 챔피언 미라. 고래왕·독파리·로파파·메깅·갸라도스·밀로틱. 대부분 전기·풀에 약하지만 메깅(물/땅)은 전기가 무효고 로파파(물/풀)는 전기·풀 둘 다 반감이다.',
    rows: [
...
const MUDKIP_GUIDE: StarterGuideData = {
  ...
  elite4: [
    {
      ...
      rows: [{ opponent: '시드니 — 그라에나 Lv.46 (선두) · 밤선인 Lv.46 · 다탱구 Lv.48 · 가재장군 Lv.48 · 앱솔 Lv.49 (전원 에스퍼 무효)', answer: '버섯모 격투기 / 보만다 드래곤클로' }],
    },
    {
      title: '사천왕 피비 (고스트 타입)',
  ...
  summary: [
    ...
    { stage: '미라', strategy: '버섯모 잎날가르기가 핵심. 로파파는 불꽃도 반감이라 중립 화력으로' },
  ],
  support: [
...
const TREECKO_GUIDE: StarterGuideData = {
  ...
  elite4: [
    {
      ...
      rows: [{ opponent: '시드니 — 그라에나 Lv.46 (선두) · 밤선인 Lv.46 · 다탱구 Lv.48 · 가재장군 Lv.48 · 앱솔 Lv.49 (전원 에스퍼 무효)', answer: '가디안 사이코키네시스 / 앱솔 격투기' }],
    },
    {
      title: '사천왕 피비 (고스트 타입)',
      note: '가디안 섀도볼 또는 앱솔 기습으로 처리.',
      rows: [{ opponent: '피비 — 미라몽 Lv.48 (선두) · 다크펫 Lv.49 · 깜까미 Lv.50 · 다크펫 Lv.49 · 미라몽 Lv.51', answer: '가디안 섀도볼 / 앱솔 기습' }],
    },
    {
      title: '사천왕 글레이시아 (얼음 타입)',
    ...
    },
    {
      ...
      rows: [{ opponent: '대엽 — 쉘곤 Lv.52 (선두) · 킹드라 Lv.53 · 플라이곤 Lv.53 · 파비코리 Lv.54 · 보만다 Lv.55', answer: '씨카이저 얼음빔 / 플라이곤 드래곤브레스' }],
    },
  ],
  champion: {
    title: '챔피언 미라 (물 타입)',
  ...
  summary: [
    ...
    { stage: '미라', strategy: '나무킹 잎날가르기 + 썬더볼트가 핵심. 로파파는 풀·전기·불꽃이 모두 1배라 중립 화력으로' },
  ],
  support: [
