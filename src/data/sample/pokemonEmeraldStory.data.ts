  ...
  movesets: [
    {
      pokemonId: 257,
      pokemon: '번치코',
      finalMoves: ['화염방사', '인파이트 / 공중날기', '지진 / 아이언테일', '화염자동차 / 스피드스타'],
      moveTable: [
    ...
    },
    {
      pokemonId: 330,
      pokemon: '플라이곤',
      finalMoves: ['지진', '공중날기', '불대문자 / 화염방사', '용의숨결 / 드래곤크루'],
      moveTable: [
...
const MUDKIP_GUIDE: StarterGuideData = {
  ...
  movesets: [
    ...
    },
    {
      pokemonId: 373,
      pokemon: '보만다',
      finalMoves: ['드래곤크루', '불대문자 / 화염방사', '지진', '공중날기'],
      moveTable: [
        { move: '드래곤크루', how: 'TM02', usage: '드래곤 물리기. E4 드레이크 파티 처리' },
...
export const EMERALD_MOVE_NAMES: ReadonlySet<string> = new Set([
  '사이코키네시스', '사이드체인지', '10만볼트', '드래곤크루', '메가드레인', '베어가르기',
  '사이코쇼크', '사이코커터', '속여때리기', '스피드스타', '아이언테일', '잎날가르기',
  '전기자석파', '트라이어택', '폭포오르기', '화염자동차', 'HP회복', '공중날기',
