...
export const HGW_WEEK: WeeklyDay[] = [
  {
    ...
    tasks: [
      ...
      { kind: 'phone', title: '관장 전화번호 — 비상 · 도희 · 유빈', place: '무지개시티 백화점 4층 / 인주시티 방울탑 가는 길', detail: '★ 월요일 백화점 4층에는 비상과 도희가 서로 아버지가 더 강한 트레이너라며 말다툼하고 있다. 둘 다 여기서 번호를 주므로 한쪽만 말 걸고 지나치지 않도록 주의한다. 유빈은 월·화요일에 방울탑 가는 길에 있다.' },
    ],
  },
  {
    day: '화',
