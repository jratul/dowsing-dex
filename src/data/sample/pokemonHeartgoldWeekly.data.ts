  ...
  },
  {
    ...
    tasks: [
      { kind: 'sibling', title: '화홍에게 휘어진스푼', place: '29번도로', detail: '2세대에서는 핑크리본을 줬지만 HGSS 에서는 휘어진스푼으로 바뀌었다. 리본은 철렁리본.' },
      {
        ...
        detail: '화·목·토요일에만 열린다. 참가비는 없고 하루 한 번. 접수할 때 선두에 둔 포켓몬 한 마리로 20분 동안 스포츠볼 20개를 써서 벌레 한 마리를 잡아 겨룬다. 1등 상품은 전국도감 전이면 태양의돌, 얻은 뒤에는 진화용 돌 8종 중 랜덤 1개다(2등 변함없는돌, 3등 자뭉열매, 참가상 아름다운허물). 스라크·쁘사이저처럼 평소에 안 나오는 벌레도 나온다.',
      },
