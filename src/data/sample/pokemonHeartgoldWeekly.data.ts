...
export const HGW_WEEK: WeeklyDay[] = [
  {
    ...
    tasks: [
      ...
      { kind: 'phone', title: '관장 전화번호 — 비상 · 도희 · 유빈', place: '무지개시티 백화점 4층 / 인주시티 방울탑 가는 길', detail: '★ 비상과 도희는 월요일에 백화점 4층에서 서로 아버지 자랑을 하며 말다툼 중이다 — 한자리에서 둘의 번호를 함께 받는다. 유빈은 월·화요일에 방울탑 가는 길에 있다.' },
    ],
  },
  {
    day: '화',
